...
export const CATEGORIES: Record<string, CategoryMeta> = {
  income:              { label: "Income",          color: "#00c896", emoji: "\u{1F4B0}", type: "income"   },
  ...
  food_and_drink:      { label: "Dining & Bars",   color: "#ff7675", emoji: "\u{1F354}", type: "expense"  },
  groceries:           { label: "Groceries",       color: "#00b894", emoji: "\u{1F6D2}", type: "expense"  },
  shopping:            { label: "Shopping",        color: "#a29bfe", emoji: "\u{1F6CD}\uFE0F", type: "expense"  },
  subscriptions:       { label: "Subscriptions",   color: "#6c5ce7", emoji: "\u{1F4F1}", type: "expense"  },
  transportation:      { label: "Transport",       color: "#74b9ff", emoji: "\u{1F697}", type: "expense"  },
  entertainment:       { label: "Entertainment",   color: "#fd79a8", emoji: "\u{1F3AC}", type: "expense"  },
  rent_and_utilities:  { label: "Bills & Utilities", color: "#0984e3", emoji: "\u{1F3E0}", type: "expense" },
  medical:             { label: "Health",          color: "#e17055", emoji: "\u{1F3E5}", type: "expense"  },
  personal_care:       { label: "Personal Care",   color: "#fab1a0", emoji: "\u{1F485}", type: "expense"  },
  travel:              { label: "Travel",          color: "#fdcb6e", emoji: "\u2708\uFE0F", type: "expense"  },
  loan_payments:       { label: "Loan Payments",   color: "#d63031", emoji: "\u{1F4B3}", type: "expense"  },
  home_improvement:    { label: "Home",            color: "#55efc4", emoji: "\u{1F527}", type: "expense"  },
  education:           { label: "Education",       color: "#ffeaa7", emoji: "\u{1F4DA}", type: "expense"  },
  pets:                { label: "Pets",            color: "#a8e063", emoji: "\u{1F43E}", type: "expense"  },
  donations:           { label: "Donations",       color: "#fd9644", emoji: "\u2764\uFE0F", type: "expense"  },
  general_services:    { label: "Services",        color: "#636e72", emoji: "\u{1F528}", type: "expense"  },
  government:          { label: "Government",      color: "#b2bec3", emoji: "\u{1F3DB}\uFE0F", type: "expense"  },
  bank_fees:           { label: "Bank Fees",       color: "#dfe6e9", emoji: "\u{1F3E6}", type: "expense"  },
  other:               { label: "Other",           color: "#747d8c", emoji: "\u{1F4E6}", type: "expense"  },
};
